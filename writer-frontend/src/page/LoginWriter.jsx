...
import style from "./LoginWriter.module.css";
    ...
    return (
        <div className={style["login-container"]} ref={backgroundRef}>
            ...
            <div className={style["request-button-wrapper"]}>
                <button type="button" className={style["submit-username-and-password"]} onClick={handleLogin}>登入</button>
                <button type="button" className={style["submit-username-and-password"]} onClick={() => navigate("/register")}>尚無帳號，前往註冊頁面</button>
            </div>
        </div>
    );
}